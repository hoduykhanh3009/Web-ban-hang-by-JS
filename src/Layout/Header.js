...
function Header() {
    ...
    function renderLogin() {
        if (x) {
            x = JSON.parse(x)
            return (
                <li><a onClick={Logout} id="cart"><i className="fa-shopping-cart"></i>Logout</a></li>
            )
        } else {
            return (
                <li><a href="/Member/login/" id="cart"><i className="fa-shopping-cart"></i>Login</a></li>
            )
        }
        function Logout() {
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-8 clearfix">
                                <div className="shop-menu clearfix pull-right">
                                    <ul className="nav navbar-nav">
                                        <li><a href="/account/Update"> <i className="fa fa-user" /> Account</a></li>
                                    ...
                                    <ul className="nav navbar-nav collapse navbar-collapse">
                                        ...
                                        <li className="dropdown"><a href="#" className="active">Blog<i className="fa fa-angle-down" /></a>
                                            <ul role="menu" className="sub-menu">
                                                ...
                                                <li><a href="/detail">Blog Single</a></li>
                                            </ul>
                                        </li>
